...
2!==a.length||"number"!==typeof a[0]||"number"!==typeof a[1])throw Error("Each point should be an array of two numbers");});a=a.filter(function(b,c){return 0===c||!(b[0]===a[c-1][0]&&b[1]===a[c-1][1])});if(2>a.length)throw Error("List of points should contain at least 2 unique points");var g=a.length,k=d.normalize(d.subtract(a[1],a[0])),g=d.normalize(d.subtract(a[g-2],a[g-1]));return w(a,k,g,c,b)}});
